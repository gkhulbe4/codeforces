/*
  ...
  - Added the required column `boilerplate` to the `Language` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `monacoId` to the `Language` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "boilerplate" TEXT NOT NULL,
ADD COLUMN     "key" TEXT NOT NULL,
ADD COLUMN     "monacoId" TEXT NOT NULL,
DROP COLUMN "id",
